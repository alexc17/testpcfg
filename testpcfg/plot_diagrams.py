...
#print(values)
p1 = plt.barh(xs, values[:,0], height = 5, label="< 1.001")
p1 = plt.barh(xs, values[:,1], height = 5, left = values[:,0],label=" (<1.01)")
p1 = plt.barh(xs, values[:,2], height = 5, left = values[:,0] + values[:,1],label=" (<1.1)")
p1 = plt.barh(xs, values[:,3], height = 5, left = values[:,0] + values[:,1] + values[:,2],label="$\geq 1.1$")
...
plt.title("Partition Function", y= 1.15)
plt.savefig("../diagrams/hbar.pdf")